...
| Folder      | Content | 
| ------      | ------- | 
| /usr/sbin   | The VSCP MQTT daemon executable is installed here. | 
...
| /etc/vscp | Configuration files are here. And especially vscpd.json, thew VSCP MQTT daemon configuration file. |
...
| /var/lib/vscp/web | The VSCP MQTT daemon package creates the web folder structure even it does not use them. This is mainly intended for the [vscpl2drv_webserv driver](https://github.com/grodansparadis/vscpl2drv-websrv) |
